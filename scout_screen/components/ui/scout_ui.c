...
//   EXPOS  slider 0-10, def 0 (AUTO) — CAM_CTRL_SET_AE_LEVEL (0x11, 0=AEC on, 1-10=aec_value*100)
//   GAIN   slider 0-10, def 0 (AUTO) — CAM_CTRL_SET_AGC_GAIN (0x12, 0=AGC on, 1-10=agc_gain*3)
