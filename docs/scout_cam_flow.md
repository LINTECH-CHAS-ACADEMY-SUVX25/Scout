...
| `watchdog` | [watchdog.c](../scout_cam/components/wdt/watchdog.c) | `watchdog_register`, `watchdog_reset` |
...
| Uses | File | Provides |
|---|---|---|
| `l298n` | [l298n.c](../scout_cam/components/motor_driver/l298n.c) | `l298n_apply(cmd)` — sets IN1–IN4 GPIO to match CMD_* bitmask |
...
| `l298n` | `components/motor_driver/` | GPIO driver | `esp_driver_gpio`, `rc_protocol` | Owns the L298N IN1–IN4 GPIO pins; interprets CMD_* bitmasks |
...
| `watchdog` | `components/wdt/` | wrapper | `esp_task_wdt` | Thin wrapper so task files never include `esp_task_wdt.h` directly |
